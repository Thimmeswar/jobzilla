...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>TalentTap Solutions | Candidate Shortlist jobs</title>
                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 class="wt-title">Candidate Shortlist jobs</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
...
$stmt = $conn->prepare("
    ...
    WHERE 
        aj.candidateid = ? AND aj.status = 'Shortlisted'
");

$stmt->bind_param("i", $candidateid);
$stmt->execute();
$result = $stmt->get_result();
$shortlisted_jobs = $result->fetch_all(MYSQLI_ASSOC);
...
<div class="twm-right-section-panel candidate-save-job site-bg-gray">
    <div class="twm-D_table table-responsive">
        <table id="jobs_bookmark_table" class="table table-bordered twm-candidate-save-job-list-wrap">
            ...
            <tbody>
                <?php if (!empty($shortlisted_jobs)): ?>
                    <?php foreach ($shortlisted_jobs as $job): ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="twm-table-controls">
                                <ul class="twm-DT-controls-icon list-unstyled" style="margin : auto;">
                                    <li>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5">No shortlisted jobs found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
